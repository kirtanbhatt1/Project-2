...
void Maintenance::on_addTeamButton_clicked()
{
    ...
    QString stadium = "Qualcomm Stadium";
    QString capacity = "71500";
    QString location = "San Diego, California";
    QString roofType = "Open";
    QString surface = "Bermuda grass";
    QString opened = "2023";
    QString division = "AFC West";
    QString id = "34";
    QString conference = "American Football Conference";
    db->prepare("INSERT INTO teamInfo (teamName, stadium, capacity, location, roofType, surface, opened, division, conference) VALUES ('""','""','""','""','""','""','""','""','""' )");
    db->exec();
    //QString id = db->value("ID").toString();
    db->prepare("UPDATE teamInfo SET teamName = '"+teamName+"', stadium = '"+stadium+"',capacity = '"+capacity+"',location = '"+location+"',roofType = '"+roofType+"',surface = '"+surface+"',opened = '"+opened+"',division = '"+division+"',conference = '"+conference+"' WHERE ID = '"+id+"'");
    db->exec();
//    db->prepare("UPDATE teamInfo SET teamName = '"+teamName+"' WHERE ID =  '"+id+"'");
//    db->exec();
//    db->prepare("UPDATE teamInfo SET stadium = '"+stadium+"' WHERE ID =  '"+id+"'");
//    db->exec();
//    db->prepare("UPDATE teamInfo SET capacity = '"+capacity+"' WHERE ID =  '"+id+"'");
//    db->exec();
//    db->prepare("UPDATE teamInfo SET location = '"+location+"' WHERE ID =  '"+id+"'");
//    db->exec();
//    db->prepare("UPDATE teamInfo SET roofType = '"+roofType+"' WHERE ID =  '"+id+"'");
//    db->exec();
//    db->prepare("UPDATE teamInfo SET surface = '"+surface+"' WHERE ID =  '"+id+"'");
//    db->exec();
//    db->prepare("UPDATE teamInfo SET opened = '"+opened+"' WHERE ID =  '"+id+"'");
//    db->exec();
//    db->prepare("UPDATE teamInfo SET division = '"+division+"' WHERE ID =  '"+id+"'");
//    db->exec();
//    db->prepare("UPDATE teamInfo SET conference = '"+conference+"' WHERE ID =  '"+id+"'");
//    db->exec();
